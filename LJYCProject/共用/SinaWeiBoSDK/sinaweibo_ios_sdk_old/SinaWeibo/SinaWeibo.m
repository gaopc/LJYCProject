...
@synthesize _needResultDataDelegate;
@synthesize _needResultDataDelegateSel;
...
- (void)dealloc
{
    ...
    self._needResultDataDelegate = nil;
    self._needResultDataDelegateSel = nil;
    [super dealloc];
}
...
- (void)logIn
{
    ...
    else
    {
        ...
        WBAuthorizeRequest *wbAuthorizeRequest = [WBAuthorizeRequest request];
        wbAuthorizeRequest.redirectURI = @"http://www.itkt.com/jsp/phone.jsp";
        wbAuthorizeRequest.scope = @"email,direct_messages_write";
        wbAuthorizeRequest.userInfo = @{@"SSO_From": @"SendMessageToWeiboViewController",
                                        @"delegate":self._needResultDataDelegate,
                                        @"selector":NSStringFromSelector( self._needResultDataDelegateSel),
