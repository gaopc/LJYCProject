...
@property (nonatomic, assign) id <UINavigationControllerDelegate, ZYQAssetPickerControllerDelegate> delegate;
...
@property (nonatomic, assign) id<ZYQTapAssetViewDelegate> delegate;
...
@property(nonatomic, assign)id<ZYQAssetViewCellDelegate> delegate;
